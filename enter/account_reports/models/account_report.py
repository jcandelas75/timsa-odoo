...
class AccountReport(models.Model):
    ...
    def _get_date_bounds_info(self, options, date_scope):
        ...
        if date_scope == 'from_beginning':
            ...
            current_period_start, _current_period_end = self.return_type_ids._get_period_boundaries(self.env.company, fields.Date.from_string(options['date']['date_from']))
            eve_of_period_start = current_period_start - relativedelta(days=1)
            date_from, date_to = self.return_type_ids._get_period_boundaries(self.env.company, eve_of_period_start)
