...
class IrCron(models.Model):
    ...
    def method_direct_trigger(self):
        ...
        try:
            ...
            # Bug en Odoo 19: method_direct_trigger intenta desempacar
            # log_record.exc_info sin verificar si es None, lo que ocurre
            # cuando el cron termina sin excepciones.
